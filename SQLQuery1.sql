...
(
    ...
    event_date	VARCHAR(512),
    organizer_email	VARCHAR(512),
    organizer_phone	VARCHAR(512),
    event_description	VARCHAR(512),
    event_type	VARCHAR(512),
    event_location	VARCHAR(512),
    event_status	VARCHAR(512),
    max_seats	INT
);

INSERT INTO EVENT1 (Event_id, event_name, event_date, organizer_email, organizer_phone, event_description, event_type, event_location, event_status, max_seats) VALUES
