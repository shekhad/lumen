CREATE TABLE bookings (
  ...
  CONSTRAINT fk_bookings_events FOREIGN KEY (event_id)
    REFERENCES events(event_id)
);

INSERT INTO bookings (booking_id, event_id, booked_date, participant_name, participant_email, participant_phone) VALUES
	('200', '1008', '10-Feb-23', 'Ashish Aggarwal', 'ashish.aggarwal@gmail.com', '9820345680'),
	('201', '1001', '5-Feb-23', 'Sumit Kumar', 'sumit.1291@gmail.com', '9236701267'),
	('202', '1005', '20-Jan-23', 'Peeyush Bansal', 'peeyush_bansal20@gmail.com', '9178026731'),
	('203', '1003', '12-Jan-23', 'Shikha Sinha', 'shikha1990@gmail.com', '9812087410'),
	('204', '1003', '21-Jan-23', 'Harshika Chaturvedi', 'harshika_chaturvedi@gmail.com', '9207417841'),
